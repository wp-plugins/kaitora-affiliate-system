   ...
   if($_GET['kdals_function'] == "recommended_sites"){
        ...
        if($kdals_out){
            ...
            foreach($kdals_out as $kdals_out_print){
				...
				include('wp-content/plugins/kdals_system/out/out_link.php');	
			}else{
				include('wp-content/plugins/kdals_system/out/out_code.php');
			}
			exit(0);                       
            }
...
function kdals_admin_call(){
    ...
    require(WP_PLUGIN_DIR.'/kdals_system/admin/adminfunc.php');
